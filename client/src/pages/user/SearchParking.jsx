...
const SearchParking = () => {
  ...
  const searchParking = async (lat, lng) => {
    ...
    try {
      ...
      const url = 'http://localhost:5001/api/v1/parking/nearby';
      const params = {
        lat,
        lng,
  ...
  const handlePayment = async (booking) => {
    ...
    try {
      ...
      const orderResponse = await axios.post('http://localhost:5001/api/v1/payments/create-order', {
      ...
      const options = {
        ...
        handler: async (response) => {
          const verifyResponse = await axios.post('http://localhost:5001/api/v1/payments/verify-payment', {
          ...
          if (verifyResponse.data.success) {
            await axios.put('http://localhost:5001/api/v1/bookings/confirm', {
              bookingId: booking._id
            }, { headers: { Authorization: `Bearer ${token}` } });
  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5001/api/v1/bookings', {
